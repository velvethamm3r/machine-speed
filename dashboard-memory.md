...
### Run 2026-08-10 (daily — coverage extended to Aug 10)

Coverage moved from Aug 5 to Aug 10; `coverageStart` unchanged at Jul 1. Five items added (50 → 55 was the Aug 5 count; board is now 60), spanning Black Hat week and early-August research. Policy and Markets returned nothing verifiable in the window and were left empty rather than padded.

**New this run (5)**
- PortSwigger HTTP Terminator: AI-assisted loop invents novel HTTP desync techniques + Apache Traffic Server zero-day; Kettle says the hardest results still needed a human · 2026-08-05 · Capability · self-reported · [PortSwigger Research, opened]
- Off-by-1 Labs (1Password): ~1 in 4 AI-generated patches actually fixes the CVE (6,080 patches, 6 CVEs, ChatGPT 5.5 + Claude Opus 4.8) · 2026-08-06 · Capability · press [primary PDF would not open; carried on Help Net Security]
- OWASP GenAI 2026 LLM Top 10: Prompt Injection and Sensitive Information Disclosure stay top two; 25% of weighting now from 6,639 real incidents · 2026-08-06 · Defense · press [genai.owasp.org would not open; carried on Help Net Security]
- Okta: gray-market proxies ('Poison Claude') resell Anthropic/OpenAI access via abused cloud credits, see every forwarded prompt; stolen API keys sold on forums · 2026-08-06 · Attacks · press [okta.com would not open; carried on Help Net Security]
- CrowdStrike 2026 Threat Hunting Report: AI embedded across adversary ops; LLMjacking ~200k requests in 2 min; STARDUST CHOLLIMA npm packages in AI-agent frameworks; cloud eCrime +171% · 2026-08-03 · Attacks · researchers · [crowdstrike.com press release, opened] (new-to-board, not in strip — date rule)

**48h strip:** the four Aug 5–6 items carry `isNew:true` (4 in strip); CrowdStrike (Aug 3) left to the date rule.
...
- Provenance: 1Password, OWASP and Okta primaries returned provenance errors in this autonomous run and were carried at press confidence on Help Net Security's reporting, with 'via Help Net Security' outlets — the same convention the Jul 9 Microsoft item uses.
...
_Synced with data.json as of the 2026-08-10 run._
...
- Cyber insurance and AI liability · No carrier has reported a paid loss traced to agentic AI misuse. The live questions are whether existing cyber wordings trigger on AI-driven losses at all, how much exposure sits as silent cover in conventional policies, and whether the January 2026 ISO generative-AI general-liability exclusion spreads. Affirmative AI products exist but name hallucination and model drift, not agentic intrusion. · 2026-07-30
